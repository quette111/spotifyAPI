  ...
  const APIController = (function(){
    ...
    return {
      ...
      getTopItems(token, tracks){
        return _getTopItems(token, tracks);
    }
    
  }
  
  })(); //causes function to fire 
  ...
  return {
      ...
      createTrackDetail(img, title, artist) {
          ...
          <div class="row col-sm-12 px-0">
              <img style='border:1px solid black; padding:20px; background-color:white;' src="${img}" alt="">        
          </div>
          <div style='font-weight:bolder; font-size:25px;' class="row col-sm-12 px-0">
