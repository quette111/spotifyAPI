...
const _getPlaylistByGenre = async (token, genreId) => {
    ...
    console.log('Fetched data for genre:', genreId);
    ...
    // Ensure the response contains 'playlists' and 'items'
    if (data && data.playlists && data.playlists.items) {
        return data.playlists.items;
    } else {
        console.error('No playlists found or invalid response for genre:', genreId);
        return [];
    }
}
...
const loadGenres = async () => {
    ...
    console.log('Available Genres:', genres); // Log the genres and IDs
